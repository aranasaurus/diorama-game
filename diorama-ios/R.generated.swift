...
struct R {
  ...
  struct image {
    static var stick: UIImage? { return UIImage(named: "stick") }
  }
  ...
  struct storyboard {
    ...
    struct main {
      static var initialViewController: diorama.GameViewController? { return instance.instantiateInitialViewController() as? diorama.GameViewController }
...
extension UIViewController {
  convenience init(nib: NibResource) {
    self.init(nibName: nib.dynamicType.name, bundle: nil)
  }
}